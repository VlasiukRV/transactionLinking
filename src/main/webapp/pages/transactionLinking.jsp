...
<head>
    ...
    <script type="text/javascript"
            src="https://cdnjs.cloudflare.com/ajax/libs/angular-ui-bootstrap/0.10.0/ui-bootstrap.js"></script>
    <script type="text/javascript"
            src="https://cdnjs.cloudflare.com/ajax/libs/angular-ui-bootstrap/0.10.0/ui-bootstrap-tpls.js"></script>
    ...
    <table class="dataTable">
        <tr>
            ...
            <td>
                ...
                <div ng-switch on="showSpecial">

                    <div ng-switch-when="true" class="matchingFull">
                        true
                    </div>

                    <div ng-switch-when="false" class="matchingNo">
                        true
                    </div>
    ...
    <span>
        <table width="900" border="0" class="dataTable">
            ...
            <tr ng-repeat="operation in transactionsLinking.operations | filter:showOperation"
                ...
                <td title="operation date" width="200" align="left" valign="top"> {{operation.operation.date |
                ...
                <td width=200>
                    <span ng-hide="operation.editCustomer" ng-click="editOperationCustomer(operation)"
                          title="customer of transaction">
                ...
                <td width="150">
                    ...
                    <button ng-click="changeRecordInTransactionsLinking(operation.operationId, operation.operation.customer.id, null)"
                            type="button" size="sm" title="del customer">
            ...
            <tr>
                <label>Filter: <%--<input ng-model="filterLevelLinking">--%>
                    <button ng-click="showHideMatchingFull()" ng-class="{matchingFull: showMatchingFull == 1}"
                            title="show/hide full matching"></button>
                    <button ng-click="showHideMatchingPartly()" ng-class="{matchingPartly: showMatchingPartly == 2}"
                            title="show/hide partly matching"></button>
                    <button ng-click="showHideMatchingNo()" ng-class="{matchingNo: showMatchingNo == 3}"
                            title="show/hide no matching"></button>
                </label>
            </tr>
        </table>
...
<div ng-controller="saleReportController">
    ...
    <span>
        ...
        <table width="900" class="dataTable">
            ...
            <tr ng-repeat="reportLine in saleReport.reportLines | filter:{customer: {customerPresentation: filterCustomer}}"
                bgcolor="#FFFDD0" class="dataTableRow">
                ...
                <td>
                    <table width="100%">
                        <tr>
                            <td title="total amount" width="100" align="right"><b> {{reportLine.totalAmount |
                                currency}} </b></td>
                    ...
                    <table width="100%">
                        <tr ng-repeat="operation in reportLine.operations">
                            ...
                            <td title="operation date" width="200" align="left"> {{operation.date | date:'yyyy-MM-dd
                                HH:mm:ss'}}
                            </td>
